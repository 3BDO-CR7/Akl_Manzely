                            ...
                            <View style={[ styles.bg_White, styles.paddingHorizontal_10, styles.paddingVertical_10, styles.Border, styles.border_gray, styles.bgFullWidth ]}>
                                ...
                                <View style={[styles.overHidden]}>
                                    <Animatable.View animation="fadeInRight" easing="ease-out" delay={500}>
                                        <Text style={[styles.textRegular , styles.text_black, styles.rowRight, styles.Width_100]}>
                                             -- الاسئله المتكرره ؟
                                        </Text>
                                        <Text style={[styles.textRegular , styles.text_light_gray, styles.rowRight, styles.Width_100, styles.marginVertical_15]}>
